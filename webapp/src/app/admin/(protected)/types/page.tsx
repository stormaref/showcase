...
export default function AdminTypesPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold tracking-tight">Design types</h1>
      <p className="mt-1 text-sm text-gray-500">
        Manage product types (e.g. wall tile, ceramic). Types in use cannot be deleted.
      </p>
            ...
            {types.length === 0 && (
              <tr>
                <td colSpan={5} className="px-4 py-8 text-center text-gray-400">
                  No types yet. Add your first design type above.
                </td>
              </tr>
            )}
          </tbody>
